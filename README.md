...
Montyll is a novel Thousand Brains System ([code](https://github.com/Xavier0301/cmontyll)) integrating elements of low-level neocortical processing e.g. accurate neuron models [^1][^2] and grid cells to represent location [^3][^4]. Montyll was explicitly designed to be aligned with the long term goals of the Thousand Brains Project ([website](https://thousandbrains.org), [paper](https://arxiv.org/abs/2412.18354)), and it is inspired by N. Leadholm, V. Clay et al.'s implementation named _Monty_ ([code](https://github.com/thousandbrainsproject/tbp.monty)).
